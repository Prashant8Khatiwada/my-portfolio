export const LEGACY_DATA = {
  projects: [
    ...
    },
    {
      ...
      live_url: "https://p-youtube-clone.netlify.app",
      github_url: null,
      image_url: null,
      featured: false,
      display_order: 9,
  ...
  skills: [
    ...
    },
    {
      ...
      category: "Styling",
      proficiency: 90,
      description: "Tailwind CSS, SCSS, ShadCN, Mantine UI, Material UI, Styled Components",
      display_order: 2,
    },
    {
      name: "Full Stack",
      category: "Backend & DB",
      proficiency: 82,
      description: "Node.js, PostgreSQL, MongoDB, MySQL, Prisma, NestJS, Firebase",
      display_order: 3,
    },
    {
      name: "DevOps",
      ...
      proficiency: 80,
      description: "Git, GitHub, Docker, CI/CD, Postman, Swagger, AWS, Vercel, Netlify",
      display_order: 4,
    },
  ],
  services: [
